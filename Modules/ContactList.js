function contactListModule() {
  ...
  // From version 001 vvvvvvvvvvvv
  // ('use strict');
  // const ContactsURL = 'http://192.168.64.9:3500/contacts';
  ...
  //         document.getElementById(`${contactListHeadersIDs}`).addEventListener('click', () => {
  //           contactList.innerHTML = '';
  ...
  //         document.getElementById(`${contactListHeadersIDs}`).addEventListener('focusin', function (e) {
