...
function populateListTable(contactData) {
  ...
  renewalCntcts.forEach((element) => {
    ...
    if (renewDateSort >= createDateSort) {
      ...
      if (renewDateSort <= reviewDateSort) tableData1.classList.add('table-danger');
      tableRow.appendChild(tableData1);

      tableData2 = document.createElement('td');
      element['LastName'] ? (tableData2.innerHTML = element['LastName']) : (tableData2.innerHTML = '');
      if (renewDateSort <= reviewDateSort) tableData2.classList.add('table-danger');
      ...
      if (renewDateSort <= reviewDateSort) tableData12.classList.add('table-danger');
      ...
      if (renewDateSort <= reviewDateSort) tableData10.classList.add('table-danger');
      ...
      if (renewDateSort <= reviewDateSort) tableData11.classList.add('table-danger');
      ...
      if (renewDateSort <= reviewDateSort) tableData8.classList.add('table-danger');
      ...
      if (renewDateSort <= reviewDateSort) tableData9.classList.add('table-danger');
      ...
      if (renewDateSort <= reviewDateSort) tableData7.classList.add('table-danger');
      ...
      // if (renewDateSort <= reviewDateSort ) tableData13.classList.add('table-danger');
